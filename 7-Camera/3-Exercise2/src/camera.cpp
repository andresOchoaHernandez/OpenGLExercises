...
glm::mat4 myLookAt(glm::vec3 pos, glm::vec3 target, glm::vec3 up)
{
    ...
    glm::vec3 rigthVersor = glm::normalize(glm::cross(glm::normalize(up), direction));
    glm::vec3 upversor = glm::cross(direction, rigthVersor);
    ...
    rotation[0][0] = rigthVersor.x; 
    rotation[1][0] = rigthVersor.y;
    rotation[2][0] = rigthVersor.z;
    rotation[0][1] = upversor.x; 
    rotation[1][1] = upversor.y;
    rotation[2][1] = upversor.z;
