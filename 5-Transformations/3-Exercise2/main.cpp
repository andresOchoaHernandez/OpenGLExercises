...
int main(int argc, char *argv[])
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        /* FIRST CONTAINER */
        glm::mat4 transformation = glm::rotate(glm::translate(glm::mat4(1.0f),glm::vec3(0.5f, -0.5f, 0.0f)),(float)glfwGetTime()*glm::radians(30.0f),glm::vec3(0.0f,0.0f,1.0f));
        ...
        /* SECOND CONTAINER */
        transformation = glm::scale(glm::translate(glm::mat4(1.0f),glm::vec3(-0.5f, 0.5f, 0.0f)),glm::vec3((float)sin(glfwGetTime()),(float)sin(glfwGetTime()),(float)sin(glfwGetTime())));
        glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm::value_ptr(transformation));
