...
int main(int argc, char *argv[])
{
    ...
    /* CREATING A WINDOW */
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGTH, "SpecularMapWithColors",nullptr,nullptr);
    if (window == nullptr)
    {
    ...
    /* READ THE IMAGE  AND BIND IT WITH THE TEXTURE OBJECT*/
    data = stbi_load("../resources/tex/lighting_maps_specular_color.png",&width,&height,&nrChannels,0);
