...
int main(int argc, char *argv[])
{
    ...
    /* CREATING A WINDOW */
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGTH, "EmissionMap",nullptr,nullptr);
    if (window == nullptr)
    {
    ...
    /* READ THE IMAGE  AND BIND IT WITH THE TEXTURE OBJECT*/
    data = stbi_load("../resources/tex/matrix.jpg",&width,&height,&nrChannels,0);
    ...
    renderShaders.setInt("material.emission",2);
