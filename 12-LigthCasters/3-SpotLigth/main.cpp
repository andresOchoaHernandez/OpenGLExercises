...
int main(int argc, char *argv[])
{
    ...
    /* CREATING A WINDOW */
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGTH, "SpotLigth",nullptr,nullptr);
    if (window == nullptr)
    {
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        /* LIGHT PROPERTIES */
        renderShaders.setVector3f("ligthPos",camera.getCamPosition());
        renderShaders.setVector3f("ligthDirection",camera.getCamDirection());

        renderShaders.setFloat("ligth.cutoff",glm::cos(glm::radians(12.5f)));
        renderShaders.setFloat("ligth.outerCutoff",glm::cos(glm::radians(17.5f)));
        ...
        renderShaders.setFloat("ligth.constant",1.0f);
        renderShaders.setFloat("ligth.linear",0.09f);
        renderShaders.setFloat("ligth.quadratic",0.032f);
