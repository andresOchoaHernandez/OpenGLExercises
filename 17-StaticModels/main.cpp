...
int main(int argc, char *argv[])
{
    ...
    /* CREATING A WINDOW */
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGTH, "Static Models",nullptr,nullptr);
    if (window == nullptr)
    {
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        normalMappingShader.setVector3f("spotLigth.ambient", glm::vec3(1.0f));
        normalMappingShader.setVector3f("spotLigth.diffuse", glm::vec3(1.0f));  
        normalMappingShader.setVector3f("spotLigth.specular",glm::vec3(1.0f));
        ...
        model = glm::scale(glm::rotate(model,glm::radians(90.0f),glm::vec3(0.0f,1.0f,0.0f)),glm::vec3(10.0f));
        normalMappingShader.setMatrix4f("model",model);
        
        wall1.Draw(normalMappingShader);
        ...
        wall2.Draw(normalMappingShader);
        ...
        wall3.Draw(normalMappingShader);

        /* DRAW WALL4 */
        model = glm::translate(glm::mat4(1.0f),glm::vec3(0.0f,-10.0f,0.0f));
        model = glm::scale(glm::rotate(model,glm::radians(-90.0f),glm::vec3(1.0f,0.0f,0.0f)),glm::vec3(10.0f));
        normalMappingShader.setMatrix4f("model",model);
