...
std::vector<Texture> getTextures()
{
    ...
    return 
    {
        {diffuseTexture,std::string("texture_diffuse"),std::string("../resources/textures/brickwall.jpg")},
        {normalTexture, std::string("texture_normal"),std::string("../resources/textures/brickwall_normal.jpg")},
    };
}
